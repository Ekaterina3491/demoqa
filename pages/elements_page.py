...
class ElementsPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.text_center = WebElement(self.driver,'#app >div> div>div.row > div.col-12.mt-4.col-md-6')
        self.text_elements = WebElement(driver,'div.col-12:nth-child(2)')
        self.icon = WebElement(driver,'header > a > img')
        self.btn_sidebar_first = WebElement(driver, 'div:nth-child(1) > span > div') #div:nth-child(1) > span > div
